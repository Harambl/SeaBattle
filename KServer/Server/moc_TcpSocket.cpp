...
QT_MOC_LITERAL(1, 10, 18), // "socketDisconnected"
QT_MOC_LITERAL(2, 29, 0), // ""
QT_MOC_LITERAL(3, 30, 10) // "deleteSelf"

    },
    "TcpSocket\0socketDisconnected\0\0deleteSelf"
};
...
void TcpSocket::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&TcpSocket::socketDisconnected)) {
                *result = 0;
                return;
            }
        }
