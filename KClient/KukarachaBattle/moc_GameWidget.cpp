...
#include <memory>
#include "Headers/GameLogic/GameWidget.h"
...
QT_MOC_LITERAL(4, 28, 10), // "rotateShip"
QT_MOC_LITERAL(5, 39, 12), // "undoDragging"
QT_MOC_LITERAL(6, 52, 12) // "redoDragging"

    },
    "GameWidget\0cellClicked\0\0pos\0rotateShip\0"
    "undoDragging\0redoDragging"
};
...
void GameWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->rotateShip(); break;
        case 2: _t->undoDragging(); break;
        case 3: _t->redoDragging(); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&GameWidget::cellClicked)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void GameWidget::cellClicked(const QPoint & _t1)
{
